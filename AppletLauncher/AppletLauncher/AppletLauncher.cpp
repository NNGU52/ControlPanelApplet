...
// AppletLauncher.cpp : Определяет поведение классов для приложения.
//
...
// Единственный объект CAppletLauncherApp

CAppletLauncherApp theApp;


// инициализация CAppletLauncherApp
